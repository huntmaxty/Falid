...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function initAuth() {
      ...
      if (!window.supabase) {
        // Se não estiver, aguardar o evento de inicialização
        document.addEventListener('supabaseInitialized', setupAuthHandlers, { once: true });
        return;
      }
      
      // Se já estiver disponível, configurar os handlers
      setupAuthHandlers();
    }
