...
const supabaseUrl = 'https://seu-supabase-url.supabase.co';  // Substitua com sua URL do Supabase
const supabaseKey = 'sua-chave-anonima-do-supabase';         // Substitua com sua chave do Supabase

// Inicializar o cliente Supabase
const supabase = createClient(supabaseUrl, supabaseKey);

// Inicializar o serviço de ofertas
const ofertaService = new OfertaService(supabaseUrl, supabaseKey);
